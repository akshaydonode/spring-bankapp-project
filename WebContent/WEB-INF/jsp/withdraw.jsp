...
<body>
    <div class="header">
        ...
        <div class="container" style="margin-top:50px; margin-left:550px" >
                <form action="/bankappusingspringmvc/app/bank/withdrawAccount" method="post">
                        ...
                        <div class="form-group">
                              ...
                              <div class="form-group">
                                    ...
                                    <input type="Number" class="form-control" style="width: 270px" id="exampleFormControlInput1" name="account_amount" placeholder="Enter Amount" required>
                                  </div>

                                  <input type="submit" value="withdraw" style="margin-left: 100px">
                        </div>
                </form>
        </div>
</body>
